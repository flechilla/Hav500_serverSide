...
{
    public class PicturesRespository : BaseApplicationService<Picture, int>, IPicturesApplicationService
    {
        protected PicturesRespository(IPicturesRepository repository) : base(repository)
        {
        }

        private new IPicturesRepository Repository { get { return Repository as IPicturesRepository; } }
